...
const props = {
  ...
  comments: [
    ...
    {id: 2, message: 'Maecenas in dapibus enim. Integer feugiat a ex sed egestas. Vestibulum eu ante turpis. Sed pharetra fringilla rutrum. Integer rhoncus, urna sit amet tristique bibendum, lorem leo mattis ipsum, ut gravida metus dui eleifend quam. Fusce lobortis ex tortor, ut vehicula elit vestibulum nec. Nulla vitae pharetra leo.'}
  ]
}
